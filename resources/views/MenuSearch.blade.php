                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        ...
                                        <div class="img">
                                            <img src="img/servicemenu/cuttinghair.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/shave.jpeg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/Makeup.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/manicure.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/Pedicure.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/lashes_brows.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/tattooing.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/spa.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/Epilation.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/skincare.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/Festivehairstyle.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
                            ...
                            <div class="card">
                                <form method="get" action="{{route('menusearch')}}">
                                    <div class="content">
                                        <button class="contentBtn" type="submit">
                                        <div class="img">
                                            <img src="img/servicemenu/solarium.jpg" alt="">
                                        </div>
                                        </button>
                                        <div class="details">
            ...
            <div class="container min-vh-100 pb-3 mt-3">
                @if(count($search) != '')
                    <div class="notfoundDiv mx-auto mb-3 text-center">
                        <label class="GeoArtMotto">@if($city == '') (აირჩიეთ ქალაქი!) @else {{$city}} -> {{ $MenuSearch }}. @endif </label>
                    </div>
                @endif
                ...
                @if(count($search) == '')
                    <div class="notfoundDiv mx-auto">
                        <label class="">@if($city == '') აირჩიეთ ქალაქი! @else {{ $MenuSearch }} -> {{$city}} ---
                            ჩანაწერი არ მოიძებნა. @endif</label>
                    </div>
                @endif
