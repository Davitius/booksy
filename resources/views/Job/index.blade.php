    ...
    <div class="row">
        ...
        <section class="col-lg-8 connectedSortable mb-3 mx-auto mt-5">
            ...
            <li class="list-group-item text-center">
                <label class="staffcode">{{Auth::user()->access}}</label>
            </li>
                    ...
                    <li class="list-group-item" style="font-size: 90%; font-weight: lighter">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" value="User" type="radio" id="customRadio1"
                                   name="access">
                            <label for="customRadio1" class="custom-control-label">მომხმარებელი.
                                (User)</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" value="Staff" type="radio" id="customRadio2"
                                   name="access">
                            <label for="customRadio2" class="custom-control-label">სალონის თანამშრომელი.
                                (Staff)</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" value="Manager" type="radio"
                                   id="customRadio3"
                                   name="access">
                            <label for="customRadio3" class="custom-control-label">სალონის მენეჯერი.</label>
                            <label class=""> (Manager)</label>
                        </div>
                        <div class="text-center mt-2">
                            <button class="btn btn-default" type="submit">სტატუსის შესცვლა</button>
                        </div>
                    </li>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8 d-flex align-items-center">
                                <label class="">სტატუსი Manager-ის შეცვლით, თქვენს მიერ შექმნილი სალონი
                                    წაიშლება!</label>
                            </div>
                        </div>
                    </div>
            ...
            <li class="list-group-item text-center">
                @if(Auth::user()->access == 'User')
                    <label class="">{{Auth::user()->access}} - ის შესაძლებლობები:</label>
                    <ul class="text-left">
                ...
                @if(Auth::user()->access == 'Manager')
                    ...
                    <ul class="text-left">
                        ...
                        <li>სალონში პერსონალის დამატება. (StaffCode-ით)</li>
