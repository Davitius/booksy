...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">სალონები</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('AdminPanel')}}">ადმინ-პანელი</a></li>
                        <li class="breadcrumb-item"><a href="{{route('AdminPanel.Salons')}}">სალონები</a></li>
                                ...
                                @foreach($Salons as $Salon)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('AdminUsers.edit', $Salon->user_id) }}">
                                                <button type="" class="btn btn-default"
                                                        title="სალონის მფლობელი">{{$Salon->user_id}}</button>
                                            </a>
                                        </td>
                                        <td>{{$Salon->name}}</td>
                                        <form action="{{route('AdminSalons.update', $Salon->id)}}" method="post">
                                            @csrf
                                            @method('patch')
                                            <td>
                                                <select class="form-control" id="status" name="status"
                                                        style="color: black">
                                                    <option class=""
                                                            value="{{ $Salon->status }}">{{ $Salon->status }}</option>
                                            ...
                                            <td>
                                                <button class="btn btn-default" title="რედაქტირება" type="submit">
                                            ...
                                            <div id="mypopup" class="popup">
                                                <div class="popup-content text-center">
                                                    ...
                                                    <div class="popup-footer">
                                                        <form method="post"
                                                              action="{{route('AdminSalons.delete', $Salon->user_id)}}">
                                                            @csrf
