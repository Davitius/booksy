    ...
    <div class="row mt-5">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($Data['ActiveRes'] as $res)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$res->starthour}}</td>
                                        <td>{{$res->salon}}</td>
                                        <td><a href="{{route('SalonStaff', $res->barber_id)}}"><button class="btn btn-default">{{$res->barber}}</button></a></td>
                                        <td>{{$res->service}}</td>
                                        <td>
                                        ...
                                        <td><textarea class="form-control" style="width: 100%; font-size: 80%"
        ...
        <div class="col-lg-2">
            <div class="CardInfo mb-3">
                ...
                <div class="mt-3">
                    <p class="" style="color: green">აქტიური ჯავშნები: {{$Data['CountActiveRes']}}</p>
                </div>
                <div class="">
                    <p class="">სულ ჯავშნები: {{$Data['CountReservs']}}</p>
                </div>
            </div>
